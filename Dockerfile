...
RUN apt-get install -y wget python-rosinstall python-rosinstall-generator python-catkin-tools git \
         ...
         python-pip python-wstool python-scipy python3-vcstool

RUN mkdir -p tiago_public_ws/src
...
RUN vcs import tiago_public_ws/src < tiago_public-melodic.rosinstall
